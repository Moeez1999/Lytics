              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(
                      top: 8.0, right: 5.0, left: 5.0, bottom: 8.0),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Hamid Mir",
                      style: TextStyle(
                          color: CommonColor.orangeColor, fontSize: 11.0)),
                  SizedBox(
                    height: 4.0,
                  ),
                  Row(
                  ...
                  RichText(
                    text: TextSpan(children: <TextSpan>[
                      ...
                      TextSpan(
                        text: "Normal",
                        style: TextStyle(
                            fontSize: 11.0, color: CommonColor.orangeColor),
                      ),
                    ]),
                  ),
                ],
